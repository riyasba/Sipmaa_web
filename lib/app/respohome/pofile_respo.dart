                ...
                child:profileController
                  ...
                  children: [
                   ...
                   profileController
                    ...
                    Row(
                      ...
                      children: [
                        Text('${profileController
                                      .profileData.first.user.name}   ').text.bold.xl.make(),
                        // Icon(
                        //   Icons.edit,
                        //   color: kblue,
                        //   size: 17,
                    ...
                    Text('${profileController
                                      .profileData.first.user.designation}').text.bold.make(),
                    ksizedbox20,
                    Divider(
                      height: 0.5,
                      color: kgrey,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            kwidth10,
                            Text('${profileController
                                      .profileData.first.user.currentCompany} ').text.sm.make(),
                          ],
                        ),
                        ksizedbox10,
                      ],
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            kwidth10,
                            Text('${profileController
                                      .profileData.first.user.designation} ').text.sm.make(),
                          ],
                        ),
                        ksizedbox10,
                        Divider(
                    ...
                    Row(
                      children: [
                        kwidth10,
                        Text('${profileController
                                      .profileData.first.user.bio ?? ""}').text.sm.make(),
                      ],
                    ),
                    ksizedbox10,
                    Padding(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Spacer(),
                                Text('${profileController
                                      .profileData.first.totalPosts}').text.semiBold.make(),
                                kwidth10
                              ],
                            ),
                            ksizedbox10,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Spacer(),
                                Text('${profileController
                                      .profileData.first.totalLikes}').text.semiBold.make(),
                                kwidth10
                              ],
                            ),
                            ksizedbox10,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Spacer(),
                                Text('${profileController
                                      .profileData.first.totalFriends}').text.semiBold.make(),
                                kwidth10
                              ],
                            ),
                            ksizedbox10,
