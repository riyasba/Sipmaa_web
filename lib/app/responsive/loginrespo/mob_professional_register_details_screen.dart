...
class MobProfessionalResgisterDetails extends StatefulWidget {
  const MobProfessionalResgisterDetails({super.key});

  @override
  State<MobProfessionalResgisterDetails> createState() => _MobProfessionalResgisterDetailsState();
}

class _MobProfessionalResgisterDetailsState extends State<MobProfessionalResgisterDetails> {
                                      ...
                                      if (_formKey.currentState!.validate()) {
                                        ...
                                        if (authController
                                          ...
                                          ProfileUpdateModel profileUpdateModel =
                                             ...
                                             authController.professionalUpdateProfile(profileUpdateModel);
                                        }
                                      }
                                    },
