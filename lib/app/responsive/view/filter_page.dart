                                                                            ...
                                                                            TextButton(
                                                                                onPressed: () {
                                                                                  if (reporingTextController.text.isNotEmpty) {
                                                                                    Get.back();
                                                                                    postsController.reportAPost(userId: postsController.profileData.first.id.toString(), postId: postsController.filterList[index].id.toString(), comment: reporingTextController.text);
                                                                                  }
                                                                                },
                                                                                child: Text(
                                                                                  "Submit",
                                          ...
                                          children: [
                                            postsController.filterList[index]
                                                ...
                                                : postsController
                                                    ...
                                                    ? InkWell(
                                                        ...
                                                        child: Text(
                                                            "${postsController.filterList[index].likeCount.toString()} Likes"))
                                                    : InkWell(
                                                        onTap: () {
                                                          Get.to(
                                                              reacton_screen(
                                            ...
                                            InkWell(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      postsController.filterList[index].comment >=
                                                              1000
                                                          ? (postsController
                                                                          .filterList[
                                                                              index]
