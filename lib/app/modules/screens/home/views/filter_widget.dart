                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          children: [
                            postsController
                                        .filterList[index].user.profilePicture ==
                                    null
                                ? const CircleAvatar(
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  postsController.filterList[index].user.name,
                                  style: ktextstyle22,
                                ),
                                Text(postsController
                                        .filterList[index].user.designation ??
                                    postsController
                        ...
                        Text(
                          timeago.format(
                              postsController.filterList[index].createdAt),
                  ...
                  Row(
                    ...
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.network(
                          postsController.filterList[index].body.toString(),
                          fit: BoxFit.cover,
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                              ...
                              child: Text(  '${postsController.filterList[index].comment} Coments'
                                  .toString(),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        LikeButton(
                          isliked:
                              postsController.filterList[index].likedByUser,
