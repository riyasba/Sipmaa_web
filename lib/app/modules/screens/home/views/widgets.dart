                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        ...
                                                                        content:
                                                                          ...
                                                                          decoration:
                                                                              const InputDecoration(hintText: "Irrelevant or annoying"),
                                                                        ),
                                                                        actions: [
                                                                          TextButton(
                                                                              onPressed: () {
                                                                  ...
                                                                  content:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        ksizedbox10,
                                                                        GetBuilder<PostsController>(builder:
                                                                            (_) {
                                                                          return Container(
                                                                            height:
                                                                                350,
                                                                            ...
                                                                            child: postController.likesList.isEmpty
                                                                                ? Center(
                                                                                    child: const Text("No Likes Yet!").text.sm.semiBold.fontFamily(GoogleFonts.poppins().fontFamily!).make(),
                                                                                  )
                                                                                : ListView.separated(
