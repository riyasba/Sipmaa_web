...
class ProfessionalResgisterDetailsWeb extends StatefulWidget {
  const ProfessionalResgisterDetailsWeb({super.key});

  @override
  State<ProfessionalResgisterDetailsWeb> createState() => _ProfessionalResgisterDetailsWebState();
}

class _ProfessionalResgisterDetailsWebState extends State<ProfessionalResgisterDetailsWeb> {
